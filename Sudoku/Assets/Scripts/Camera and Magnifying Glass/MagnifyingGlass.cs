...
public class MagnifyingGlass : MonoBehaviour
{
    ...
    private void createMagnifyGlass()
    {
        ...
        magnifyCamera = this.gameObject.AddComponent<Camera>();
        ...
        if (Camera.main.orthographic)
        {
            ...
            magnifyCamera.orthographicSize = Camera.main.orthographicSize / 12.0f;//+ 1.0f;
            createBordersForMagniyGlass();
        }
        else
        {
            magnifyCamera.orthographic = false;
            magnifyCamera.fieldOfView = Camera.main.fieldOfView / 15.0f;//3.0f;
        }
    ...
    private void createBordersForMagniyGlass()
    {
        ...
        magnifyBorders.transform.parent = this.gameObject.transform;
